...
from App.Laboratorio.views import SolicitudCreate, SolicitudUpdate, SolicitudList, SolicitudDelete, SolicitudUpdate2
from App.Laboratorio.views import Detalle_examenCreate, Detalle_examen_List
from App.Laboratorio.views import Detalle_examen_Delete, Detalle_examen_Update, index2
app_name = 'App'
...
urlpatterns = [
    ...
    path('EditarSolicitud2/<pk>', login_required(SolicitudUpdate2.as_view()), name='editar_solicitud2'),
    ...
    path('MisResultados', login_required(index2), name='ver_lista2'),
